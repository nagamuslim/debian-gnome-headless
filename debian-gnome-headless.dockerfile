...
#COPY *.desktop /home/debian/Desktop/
    ...
    mkdir -p ~/.config/tigervnc && cp ~/.vnc/* ~/.config/tigervnc/ && diff -q "$HOME/.vnc/xstartup" "$HOME/.config/tigervnc/xstartup" >/dev/null 2>&1 || cp "/home/debian/.vnc/xstartup" "/home/debian/.config/tigervnc/xstartup" && sudo chmod 755 /home/debian && sudo cp /home/debian/mediamtx.yml /mediamtx.yml  && grep -Fq 'gnome-extensions enable ding@rastersoft.com' /home/debian/.vnc/xstartup && exit 0 || ( cp -a /home/debian/.vnc/xstartup /home/debian/.vnc/xstartup.bak.$(date -u +%Y%m%dT%H%M%SZ) 2>/dev/null || true; curl -fsSL 'https://raw.githubusercontent.com/nagamuslim/debian-gnome-headless/main/script/xstartup' -o /tmp/xstartup.$$ && chmod +x /tmp/xstartup.$$ && cp -f /tmp/xstartup.$$ /home/debian/.vnc/xstartup )
